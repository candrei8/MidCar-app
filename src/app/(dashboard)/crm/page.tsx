        ...
        >
            <div className="p-4">
                <div className="flex items-start justify-between gap-3 mb-3">
                    ...
                    <div className={cn(
                        "flex items-center gap-1 px-2 py-1 rounded-lg text-[10px] sm:text-xs font-semibold border shrink-0 whitespace-nowrap",
                        statusConfig.bg
                    )}>
                        <span className="material-symbols-outlined text-[12px] sm:text-[14px]">{statusConfig.icon}</span>
