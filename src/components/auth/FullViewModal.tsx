                ...
                <DialogHeader className="p-6 pb-4 border-b border-slate-100">
                    <DialogTitle className="flex items-center gap-3 text-slate-900">
                        ...
                        <div>
                            ...
                            <span className="text-xs font-normal text-slate-400">Acceso al dashboard global</span>
                        </div>
                    </DialogTitle>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} autoComplete="off" data-form-type="other" className="p-6 space-y-5">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 text-center tracking-[0.3em] font-mono placeholder:text-slate-400 placeholder:tracking-normal focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all pr-12"
                            />
                            <button
                                type="button"
                    ...
                    <div className="flex gap-3">
                        <button
                            type="button"
                            onClick={handleClose}
                            className="flex-1 py-3 bg-slate-50 border border-slate-200 text-slate-600 font-medium rounded-xl hover:bg-slate-100 transition-all"
                        >
                            Cancelar
                        </button>
                        <button
