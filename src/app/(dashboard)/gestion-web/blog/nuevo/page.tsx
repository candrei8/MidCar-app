          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg shadow-emerald-600/20">
                <span className="material-symbols-outlined text-white" style={{ fontSize: '22px' }}>add_circle</span>
              </div>
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-slate-900">Nuevo Artículo</h1>
                <p className="text-xs text-slate-500 mt-0.5">Crear un nuevo artículo para el blog</p>
              </div>
            </div>
          </div>
